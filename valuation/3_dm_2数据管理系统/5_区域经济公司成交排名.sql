...
insert overwrite table dm_evaluation.deal_month_agency_rank_district
select
...
agency_name,
count(1) as deal_cnt,
row_number() over(partition by city_cd,district_cd,substring(t1.deal_date,1,7) order by count(1) desc) as ranks,

...
select
    ...
    rank() over(partition by t1.community_id,t1.area_interval order by t1.community_goods_cnt desc) as community_rack_cnt_rank,
    t1.community_avg_price as rack_avg_price,
    t2.community_cnt as community_deal_cnt,
    rank() over(partition by t2.community_id,t2.bk_interval order by t2.community_cnt desc ) as community_deal_cnt_rank,

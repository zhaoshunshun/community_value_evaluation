...
select
    ...
    t1.subway_2km_name,
    t1.bus_2km_name,
    case when t1.bus_2km_ranks<0.2 then 0
         when t1.bus_2km_ranks >=0.2 and t1.bus_2km_ranks<0.4 then 1
         when t1.bus_2km_ranks >=0.4 and t1.bus_2km_ranks<0.6 then 2
         when t1.bus_2km_ranks >=0.6 and t1.bus_2km_ranks<0.8 then 3
         when t1.bus_2km_ranks >=0.8 and t1.bus_2km_ranks<0.9 then 4
         when t1.bus_2km_ranks >=0.9  then 5 end as bus_2km_score,
    case when t1.subway_2km_ranks<0.2 then 0
         when t1.subway_2km_ranks >=0.2 and t1.subway_2km_ranks<0.4 then 1
         when t1.subway_2km_ranks >=0.4 and t1.subway_2km_ranks<0.6 then 2
         when t1.subway_2km_ranks >=0.6 and t1.subway_2km_ranks<0.8 then 3
         when t1.subway_2km_ranks >=0.8 and t1.subway_2km_ranks<0.9 then 4
         when t1.subway_2km_ranks >=0.9  then 5 end as subway_2km_score,
    ...
    t1.primary_3km_name,
    t1.middle_3km_name,
    case when t1.nursery_3km_ranks<0.2 then 0
         when t1.nursery_3km_ranks >=0.2 and t1.nursery_3km_ranks<0.4 then 1
         when t1.nursery_3km_ranks >=0.4 and t1.nursery_3km_ranks<0.6 then 2
         when t1.nursery_3km_ranks >=0.6 and t1.nursery_3km_ranks<0.8 then 3
         when t1.nursery_3km_ranks >=0.8 and t1.nursery_3km_ranks<0.9 then 4
         when t1.bus_2km_ranks >=0.9  then 5 end as nursery_3km_score,
    case when t1.primary_3km_ranks<0.2 then 0
         when t1.primary_3km_ranks >=0.2 and t1.primary_3km_ranks<0.4 then 1
         when t1.primary_3km_ranks >=0.4 and t1.primary_3km_ranks<0.6 then 2
         when t1.primary_3km_ranks >=0.6 and t1.primary_3km_ranks<0.8 then 3
         when t1.primary_3km_ranks >=0.8 and t1.primary_3km_ranks<0.9 then 4
         when t1.primary_3km_ranks >=0.9  then 5 end as primary_3km_score,
    case when t1.middle_3km_ranks<0.2 then 0
         when t1.middle_3km_ranks >=0.2 and t1.middle_3km_ranks<0.4 then 1
         when t1.middle_3km_ranks >=0.4 and t1.middle_3km_ranks<0.6 then 2
         when t1.middle_3km_ranks >=0.6 and t1.middle_3km_ranks<0.8 then 3
         when t1.middle_3km_ranks >=0.8 and t1.middle_3km_ranks<0.9 then 4
         when t1.middle_3km_ranks >=0.9  then 5 end as middle_3km_score,
    ...
    t1.hospital_3km_cnt,
    t1.three_hospital_3km_cnt,
    t3.hospital_cnt,
    t3.three_hospital_cnt,
    t1.hospital_3km_name,
    t1.three_hospital_3km_name,
    case when t1.hospital_3km_ranks<0.2 then 0
         when t1.hospital_3km_ranks >=0.2 and t1.hospital_3km_ranks<0.4 then 1
         when t1.hospital_3km_ranks >=0.4 and t1.hospital_3km_ranks<0.6 then 2
         when t1.hospital_3km_ranks >=0.6 and t1.hospital_3km_ranks<0.8 then 3
         when t1.hospital_3km_ranks >=0.8 and t1.hospital_3km_ranks<0.9 then 4
         when t1.hospital_3km_ranks >=0.9  then 5 end as hospital_3km_score,
    case when t1.three_hospital_3km_ranks<0.2 then 0
         when t1.three_hospital_3km_ranks >=0.2 and t1.three_hospital_3km_ranks<0.4 then 1
         when t1.three_hospital_3km_ranks >=0.4 and t1.three_hospital_3km_ranks<0.6 then 2
         when t1.three_hospital_3km_ranks >=0.6 and t1.three_hospital_3km_ranks<0.8 then 3
         when t1.three_hospital_3km_ranks >=0.8 and t1.three_hospital_3km_ranks<0.9 then 4
         when t1.three_hospital_3km_ranks >=0.9  then 5 end as three_hospital_3km_score,
    ...
    t1.shopping_3km_cnt,
    t1.supermarket_3km_cnt,
    t3.shopping_cnt,
    t3.supermarket_cnt,
    t1.shopping_3km_name,
    t1.supermarket_3km_name,
    case when t1.shopping_3km_ranks<0.2 then 0
         when t1.shopping_3km_ranks >=0.2 and t1.shopping_3km_ranks<0.4 then 1
         when t1.shopping_3km_ranks >=0.4 and t1.shopping_3km_ranks<0.6 then 2
         when t1.shopping_3km_ranks >=0.6 and t1.shopping_3km_ranks<0.8 then 3
         when t1.shopping_3km_ranks >=0.8 and t1.shopping_3km_ranks<0.9 then 4
         when t1.shopping_3km_ranks >=0.9  then 5 end as shopping_3km_score,
    case when t1.supermarket_3km_ranks<0.2 then 0
         when t1.supermarket_3km_ranks >=0.2 and t1.supermarket_3km_ranks<0.4 then 1
         when t1.supermarket_3km_ranks >=0.4 and t1.supermarket_3km_ranks<0.6 then 2
         when t1.supermarket_3km_ranks >=0.6 and t1.supermarket_3km_ranks<0.8 then 3
         when t1.supermarket_3km_ranks >=0.8 and t1.supermarket_3km_ranks<0.9 then 4
         when t1.supermarket_3km_ranks >=0.9  then 5 end as supermarket_3km_score,
    ...
    t1.greenland_3km_cnt,
    t1.movie_3km_cnt,
    t1.coffee_3km_cnt,
    t3.greenland_cnt,
    t3.coffee_cnt,
    t3.movie_cnt,
    t1.greenland_3km_name,
    t1.movie_3km_name,
    t1.coffee_3km_name,
    case when t1.greenland_3km_ranks<0.2 then 0
         when t1.greenland_3km_ranks >=0.2 and t1.greenland_3km_ranks<0.4 then 1
         when t1.greenland_3km_ranks >=0.4 and t1.greenland_3km_ranks<0.6 then 2
         when t1.greenland_3km_ranks >=0.6 and t1.greenland_3km_ranks<0.8 then 3
         when t1.greenland_3km_ranks >=0.8 and t1.greenland_3km_ranks<0.9 then 4
         when t1.greenland_3km_ranks >=0.9  then 5 end as greenland_3km_score,
    case when t1.movie_3km_ranks<0.2 then 0
         when t1.movie_3km_ranks >=0.2 and t1.movie_3km_ranks<0.4 then 1
         when t1.movie_3km_ranks >=0.4 and t1.movie_3km_ranks<0.6 then 2
         when t1.movie_3km_ranks >=0.6 and t1.movie_3km_ranks<0.8 then 3
         when t1.movie_3km_ranks >=0.8 and t1.movie_3km_ranks<0.9 then 4
         when t1.movie_3km_ranks >=0.9  then 5 end as movie_3km_score,
    case when t1.coffee_3km_ranks<0.2 then 0
         when t1.coffee_3km_ranks >=0.2 and t1.coffee_3km_ranks<0.4 then 1
         when t1.coffee_3km_ranks >=0.4 and t1.coffee_3km_ranks<0.6 then 2
         when t1.coffee_3km_ranks >=0.6 and t1.coffee_3km_ranks<0.8 then 3
         when t1.coffee_3km_ranks >=0.8 and t1.coffee_3km_ranks<0.9 then 4
         when t1.coffee_3km_ranks >=0.9  then 5 end as coffee_3km_score,
...
as
    ...
    select
        ...
        cast(t1.subway_2km_score*0.6 +  t1.bus_2km_score*0.4 as decimal(10,4)) as traffic_score,
        cast(t1.sub_district_rank_score*0.6 + t1.bus_district_rank_score*0.4 as decimal(10,4)) as district_traffic_score,
        t1.bus_2km_cnt as traffic_bus_cnt,
        t1.subway_2km_cnt as traffic_subway_cnt,
        t1.bus_cnt as district_traffic_bus_cnt,
        t1.sub_cnt as traffic_subway_list,
        regexp_replace(t1.bus_2km_name ,';|；',',') as bus_2km_name,
        regexp_replace(t1.subway_2km_name ,';|；',',') as subway_2km_name,
        t1.subway_nearby_distince,
        cast(t1.nursery_3km_score*0.4+  t1.primary_3km_score*0.4+    t1.middle_3km_score*0.2 as decimal(10,4)) as education_score,
        ...
        t1.nursery_3km_cnt as education_nursery_cnt,
        t1.primary_3km_cnt as education_primary_cnt,
        t1.middle_3km_cnt as education_middle_cnt,
        ...
        regexp_replace(t1.nursery_3km_name ,';|；',',') as education_nursery_list,
        regexp_replace(t1.primary_3km_name ,';|；',',') as education_primary_list,
        regexp_replace(t1.middle_3km_name ,';|；',',') as education_middle_list,
        cast(t1.hospital_3km_score *0.5+  t1.three_hospital_3km_score*0.5 as decimal(10,4)) as hospital_score,
        ...
        t1.hospital_3km_cnt as hospital_cnt,
        t1.three_hospital_3km_cnt as three_hospital_cnt,
        t1.hospital_cnt as district_hospital_cnt,
        t1.three_hospital_cnt as district_three_hospital_cnt,
        regexp_replace(t1.hospital_3km_name ,';|；',',') as hospital_list,
        regexp_replace(t1.three_hospital_3km_name ,';|；',',') as three_hospital_list,
        cast(t1.shopping_3km_score * 0.5 + t1.supermarket_3km_score*0.5 as decimal(10,4)) as shopping_score,
        ...
        t1.supermarket_3km_cnt as shopping_supermarket_cnt,
        t1.shopping_3km_cnt as shopping_mall_cnt,
        t1.supermarket_cnt as district_shopping_supermarket_cnt,
        t1.shopping_cnt as district_shopping_mall_cnt,
        regexp_replace(t1.supermarket_3km_name ,';|；',',') as shopping_supermarket_list,
        regexp_replace(t1.shopping_3km_name ,';|；',',') as shopping_mall_list,
        cast(t1.greenland_3km_score*0.35+ t1.movie_3km_score*0.3+ t1.coffee_3km_score*0.35 as decimal(10,4)) as arder_score,
        ...
        t1.coffee_3km_cnt as coffee_house_cnt,
        t1.greenland_3km_cnt as greenland_cnt,
        t1.movie_3km_cnt as movie_cnt,
        t1.coffee_cnt as district_coffee_house_cnt,
        t1.greenland_cnt as district_greenland_cnt,
        t1.movie_cnt as district_movie_cnt,
        regexp_replace(t1.coffee_3km_name ,';|；',',') as coffee_house_list,
        regexp_replace(t1.greenland_3km_name ,';|；',',') as greenland_list,
        regexp_replace(t1.movie_3km_name,';|；',',') as movie_list,
